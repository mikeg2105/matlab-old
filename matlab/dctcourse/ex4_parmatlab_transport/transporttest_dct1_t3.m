...
createTask(parjob, 'transporttestpar3', 1, {1});
...
timea3k1(j,k)=time(1,1)/numprocs
timea3k2(j,k)=time(1,2)/numprocs
timea3k3(j,k)=time(1,3)/numprocs
...
save('jobdatt1.mat', 'timea3k1','timea3k2' ,'timea3k3','-v6')
%save('jobout.mat','-v6');
