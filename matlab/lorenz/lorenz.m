  ...
  smat=zeros(4,nsteps);
	...
	for ii=1:nsteps
	      ...
	      %susceptible 
				...
				[tx,x]=ode45(@sdotx, [t0 t],xold,[], p, yold);
				[ty,y]=ode45(@sdoty, [t0 t],yold,[],r,xold,zold);			
                [tz,z]=ode45(@sdotz, [t0 t],zold,[],b,xold,yold);
	...
	smat(1, ii)=x(size(x,1));
	smat(2, ii)=y(size(y,1));
    smat(3, ii)=z(size(z,1));
    smat(4, ii)=t;
