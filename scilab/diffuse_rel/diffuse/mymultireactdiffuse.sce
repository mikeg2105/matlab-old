function [mymultireactdiffuse]=mymultireactdiffuse(sdir,jobname,nsteps, nsubsteps, dt, dif, in, concs, sources, sinks,inconsts)
  ...
  //smat=zeros(4,nsteps)
	...
	for ii=1:nsteps
      ...
      savemconcs(sdir,jobname,ii,n1,n2,n3,nspecies, concs);
