function [alp,cux,cuy,cuz,uxx,uxy,uxz,uyy,uyz,uzz,qxx,qxy,qxz,qyy,qyz,qzz,dxuxx,dxuxy,dxuxz,dxuyy,dxuyz,dxuzz,...
             ...
             dzuxx,dzuxy,dzuxz,dzuyy,dzuyz,dzuzz]=method_parts(...
             nx,ny,nz,...
             dt,dx,dy,dz,...
             x,y,z,r,...
             txx, txy, txz, tyy, tyz, tzz,...
             psi,alp,cux,cuy,cuz,rg,...             
...
//     declare old vars...................................................
//     That is, the whole vector U at the time step n.
...
//     declare sources ...................................................
//     Only for the quantities that do have sources.
//     real s_alp(nx,ny,nz)
...
//     declare fluxes ....................................................
//     Only for the qxx,qxy,... as they are the only quantities with
//     nontrivial fluxes. The derivatives dxuxx, ... do have fluxes
//     that turn out to be (but not by miracle) exactly the sources
//     of the uxx,uxy,...
...
// .......................................................................
//     store current level n in old values. 
      old_alp = alp;
      old_cux = cux;
      old_cuy = cuy; 
      old_cuz = cuz;
...
//c     First quantities without fluxes
      alp(2:nx,2:ny,2:nz) = alp(2:nx,2:ny,2:nz) + dt.*s_alp(2:nx,2:ny,2:nz);
      cux(2:nx,2:ny,2:nz) = cux(2:nx,2:ny,2:nz) + dt.*s_cux(2:nx,2:ny,2:nz);
      cuy(2:nx,2:ny,2:nz) = cuy(2:nx,2:ny,2:nz) + dt.*s_cuy(2:nx,2:ny,2:nz);
      cuz(2:nx,2:ny,2:nz) = cuz(2:nx,2:ny,2:nz) + dt.*s_cuz(2:nx,2:ny,2:nz);
      uxx(2:nx,2:ny,2:nz) = uxx(2:nx,2:ny,2:nz) + dt.*s_uxx(2:nx,2:ny,2:nz);
      uxy(2:nx,2:ny,2:nz) = uxy(2:nx,2:ny,2:nz) + dt.*s_uxy(2:nx,2:ny,2:nz);
      uxz(2:nx,2:ny,2:nz) = uxz(2:nx,2:ny,2:nz) + dt.*s_uxz(2:nx,2:ny,2:nz);
      uyy(2:nx,2:ny,2:nz) = uyy(2:nx,2:ny,2:nz) + dt.*s_uyy(2:nx,2:ny,2:nz);
      uyz(2:nx,2:ny,2:nz) = uyz(2:nx,2:ny,2:nz) + dt.*s_uyz(2:nx,2:ny,2:nz);
      uzz(2:nx,2:ny,2:nz) = uzz(2:nx,2:ny,2:nz) + dt.*s_uzz(2:nx,2:ny,2:nz);
//     the metric derivatives have a trivial flux and no source
//     x direction
      dxuxx(2:nx,2:ny,2:nz) = dxuxx(2:nx,2:ny,2:nz)+ dt./dx.*( s_uxx(2:nx,2:ny,2:nz) - s_uxx(1:nx-1,2:ny,2:nz) );
      dxuxy(2:nx,2:ny,2:nz) = dxuxy(2:nx,2:ny,2:nz)+ dt./dx.*( s_uxy(2:nx,2:ny,2:nz) - s_uxy(1:nx-1,2:ny,2:nz) );
      dxuxz(2:nx,2:ny,2:nz) = dxuxz(2:nx,2:ny,2:nz)+ dt./dx.*( s_uxz(2:nx,2:ny,2:nz) - s_uxz(1:nx-1,2:ny,2:nz) );
      dxuyy(2:nx,2:ny,2:nz) = dxuyy(2:nx,2:ny,2:nz)+ dt./dx.*( s_uyy(2:nx,2:ny,2:nz) - s_uyy(1:nx-1,2:ny,2:nz) );
      dxuyz(2:nx,2:ny,2:nz) = dxuyz(2:nx,2:ny,2:nz)+ dt./dx.*( s_uyz(2:nx,2:ny,2:nz) - s_uyz(1:nx-1,2:ny,2:nz) );
      dxuzz(2:nx,2:ny,2:nz) = dxuzz(2:nx,2:ny,2:nz)+ dt./dx.*( s_uzz(2:nx,2:ny,2:nz) - s_uzz(1:nx-1,2:ny,2:nz) );
//c     y direction
      dyuxx(2:nx,2:ny,2:nz) = dyuxx(2:nx,2:ny,2:nz)+ dt./dy.*( s_uxx(2:nx,2:ny,2:nz) - s_uxx(2:nx,1:ny-1,2:nz) );
      dyuxy(2:nx,2:ny,2:nz) = dyuxy(2:nx,2:ny,2:nz)+ dt./dy.*( s_uxy(2:nx,2:ny,2:nz) - s_uxy(2:nx,1:ny-1,2:nz) );
      dyuxz(2:nx,2:ny,2:nz) = dyuxz(2:nx,2:ny,2:nz)+ dt./dy.*( s_uxz(2:nx,2:ny,2:nz) - s_uxz(2:nx,1:ny-1,2:nz) );
      dyuyy(2:nx,2:ny,2:nz) = dyuyy(2:nx,2:ny,2:nz)+ dt./dy.*( s_uyy(2:nx,2:ny,2:nz) - s_uyy(2:nx,1:ny-1,2:nz) );
      dyuyz(2:nx,2:ny,2:nz) = dyuyz(2:nx,2:ny,2:nz)+ dt./dy.*( s_uyz(2:nx,2:ny,2:nz) - s_uyz(2:nx,1:ny-1,2:nz) );
      dyuzz(2:nx,2:ny,2:nz) = dyuzz(2:nx,2:ny,2:nz)+ dt./dy.*( s_uzz(2:nx,2:ny,2:nz) - s_uzz(2:nx,1:ny-1,2:nz) );
//c     z direction
      dzuxx(2:nx,2:ny,2:nz) = dzuxx(2:nx,2:ny,2:nz)+ dt./dz.*( s_uxx(2:nx,2:ny,2:nz) - s_uxx(2:nz,2:ny,1:nz-1) );
      dzuxy(2:nx,2:ny,2:nz) = dzuxy(2:nx,2:ny,2:nz)+ dt./dz.*( s_uxy(2:nx,2:ny,2:nz) - s_uxy(2:nz,2:ny,1:nz-1) );
      dzuxz(2:nx,2:ny,2:nz) = dzuxz(2:nx,2:ny,2:nz)+ dt./dz.*( s_uxz(2:nx,2:ny,2:nz) - s_uxz(2:nz,2:ny,1:nz-1) );
      dzuyy(2:nx,2:ny,2:nz) = dzuyy(2:nx,2:ny,2:nz)+ dt./dz.*( s_uyy(2:nx,2:ny,2:nz) - s_uyy(2:nz,2:ny,1:nz-1) );
      dzuyz(2:nx,2:ny,2:nz) = dzuyz(2:nx,2:ny,2:nz)+ dt./dz.*( s_uyz(2:nx,2:ny,2:nz) - s_uyz(2:nz,2:ny,1:nz-1) );
      dzuzz(2:nx,2:ny,2:nz) = dzuzz(2:nx,2:ny,2:nz)+ dt./dz.*( s_uzz(2:nx,2:ny,2:nz) - s_uzz(2:nz,2:ny,1:nz-1) );

//     Now the only "interesting" quantities with full 3d flux and source
      qxx(2:nx,2:ny,2:nz) = qxx(2:nx,2:ny,2:nz) + dt.*s_qxx(2:nx,2:ny,2:nz) +...
                   dt./dx.*( fxxx(2:nx,2:ny,2:nz) - fxxx(1:nx-1,2:ny,2:nz) ) +...
                   dt./dy.*( fyxx(2:nx,2:ny,2:nz) - fyxx(2:nx,1:ny-1,2:nz) ) +...
                   dt./dz.*( fzxx(2:nx,2:ny,2:nz) - fzxx(2:nz,2:ny,1:nz-1) ); 
      qxy(2:nx,2:ny,2:nz) = qxy(2:nx,2:ny,2:nz) + dt.*s_qxy(2:nx,2:ny,2:nz) +...
                   dt./dx.*( fxxy(2:nx,2:ny,2:nz) - fxxy(1:nx-1,2:ny,2:nz) ) +...
                   dt./dy.*( fyxy(2:nx,2:ny,2:nz) - fyxy(2:nx,1:ny-1,2:nz) ) +...
                   dt./dz.*( fzxy(2:nx,2:ny,2:nz) - fzxy(2:nz,2:ny,1:nz-1) ); 
      qxz(2:nx,2:ny,2:nz) = qxz(2:nx,2:ny,2:nz) + dt.*s_qxz(2:nx,2:ny,2:nz) +...
                   dt./dx.*( fxxz(2:nx,2:ny,2:nz) - fxxz(1:nx-1,2:ny,2:nz) ) +...
                   dt./dy.*( fyxz(2:nx,2:ny,2:nz) - fyxz(2:nx,1:ny-1,2:nz) ) +...
                   dt./dz.*( fzxz(2:nx,2:ny,2:nz) - fzxz(2:nz,2:ny,1:nz-1) ); 
      qyy(2:nx,2:ny,2:nz) = qyy(2:nx,2:ny,2:nz) + dt.*s_qyy(2:nx,2:ny,2:nz) +...
                   dt./dx.*( fxyy(2:nx,2:ny,2:nz) - fxyy(1:nx-1,2:ny,2:nz) ) +...
                   dt./dy.*( fyyy(2:nx,2:ny,2:nz) - fyyy(2:nx,1:ny-1,2:nz) ) +...
                   dt./dz.*( fzyy(2:nx,2:ny,2:nz) - fzyy(2:nz,2:ny,1:nz-1) ); 
      qyz(2:nx,2:ny,2:nz) = qyz(2:nx,2:ny,2:nz) + dt.*s_qyz(2:nx,2:ny,2:nz) +...
                   dt./dx.*( fxyz(2:nx,2:ny,2:nz) - fxyz(1:nx-1,2:ny,2:nz) ) +...
                   dt./dy.*( fyyz(2:nx,2:ny,2:nz) - fyyz(2:nx,1:ny-1,2:nz) ) +...
                   dt./dz.*( fzyz(2:nx,2:ny,2:nz) - fzyz(2:nz,2:ny,1:nz-1) ); 
      qzz(2:nx,2:ny,2:nz) = qzz(2:nx,2:ny,2:nz) + dt.*s_qzz(2:nx,2:ny,2:nz) +...
                   dt./dx.*( fxzz(2:nx,2:ny,2:nz) - fxzz(1:nx-1,2:ny,2:nz) ) +...
                   dt./dy.*( fyzz(2:nx,2:ny,2:nz) - fyzz(2:nx,1:ny-1,2:nz) ) +...
                   dt./dz.*( fzzz(2:nx,2:ny,2:nz) - fzzz(2:nz,2:ny,1:nz-1) ); 
...
//c     sources and fluxes. But first, we need to get the "down" metric
      ...
      [gxx,gxy,gxz,gyy,gyz,gzz,rg]=invert(nx,ny,nz,1,...
          uxx,uxy,uxz,uyy,uyz,uzz...
          );
...
//     derivatives with no source and trivial flux
//     x direction
...
// .......................................................................
//     Now we compute the final evolved value. Again, we store it
//     in the same variables, so the evolved values have replaced the
//     original ones.
      alp = (old_alp + alp) ./2.;
      cux = (old_cux + cux) ./2.;
      cuy = (old_cuy + cuy) ./2.;
