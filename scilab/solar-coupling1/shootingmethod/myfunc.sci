function res=myfuncchi(params,tchi,tpi,rrt)
      ...
      res=chidash(params,rrt,params.m,params.k,params.om,params.p,tchi,tpi)

endfunction


function res=myfuncpi(params,tchi,tpi,rrt)
         res=pidash(params,rrt,params.m,params.k,params.om,params.p,tchi,tpi);
endfunction
...
function rchidash=chidash(params,r,m,k,om,p,chi,rpi)
    rgamma=1.666666667;
    rchidash=-(r/N(params,r,m,k,om,p))*(C(params,r,m,k,om,p)*chi+D(params,r,m,k,om,p)*rpi)
endfunction

function rpidash=pidash(params,r,m,k,om,p,chi,rpi)
    rgamma=1.666666667;
    rpidash=-(r/N(params,r,m,k,om,p))*(E(params,r,m,k,om,p)*chi-C(params,r,m,k,om,p)*rpi);
endfunction
